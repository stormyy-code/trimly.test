...
export const translations = {
  hr: {
    ...
    verifyCode: 'Verifikacija računa',
    enterOtp: 'Unesite 6-znamenkasti kod koji smo vam poslali',
  ...
  en: {
    ...
    verifyCode: 'Account Verification',
    enterOtp: 'Enter the 6-digit code we sent you',
