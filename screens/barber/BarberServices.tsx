        ...
        <Card className="p-8 space-y-6 border-white/10 animate-lux-fade bg-zinc-950">
          <div className="flex flex-col items-center gap-4">
            <div 
              ...
              className="w-full aspect-video bg-black rounded-3xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-3 cursor-pointer overflow-hidden relative group"
            >
              {imageUrl ? (
                <>
